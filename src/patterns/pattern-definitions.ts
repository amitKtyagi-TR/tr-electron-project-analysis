...
import type { SupportedLanguage, FileAnalysis } from '../types/index.js';

/**
 * A pattern that can be matched against code or file structure
 */
export interface PatternDefinition {
  ...
  description: string;
  /** Weight/importance of this pattern (1-10) */
  weight: number;
  /** Type of pattern matching */
  type: 'import' | 'function_call' | 'class_name' | 'file_name' | 'decorator' | 'content';
...
/**
 * Framework signature containing all patterns for detection
 */
export interface FrameworkSignature {
  /** Framework name */
  name: string;
  /** Minimum confidence score needed (0-1) */
  minConfidence: number;
  /** All patterns that can indicate this framework */
  patterns: PatternDefinition[];
  /** Primary languages associated with this framework */
 ...
 */
export const REACT_PATTERNS: FrameworkSignature = {
  name: 'React',
  minConfidence: 0.3,
 ...
 */
export const DJANGO_PATTERNS: FrameworkSignature = {
  name: 'Django',
  minConfidence: 0.4,
 ...
 */
export const NESTJS_PATTERNS: FrameworkSignature = {
  name: 'NestJS',
  minConfidence: 0.4,
 ...
 */
export const FLUTTER_PATTERNS: FrameworkSignature = {
  name: 'Flutter',
  minConfidence: 0.4,
 ...
 */
export const EXPRESS_PATTERNS: FrameworkSignature = {
  name: 'Express',
  minConfidence: 0.3,
  primaryLanguages: ['javascript', 'typescript'],
  patterns: [
 ...
 */
export function getFrameworkSignature(name: string): FrameworkSignature | undefined {
  return ALL_FRAMEWORK_SIGNATURES.find(sig => sig.name.toLowerCase() === name.toLowerCase());
}
...
export function getSupportedFrameworks(): string[] {
  return ALL_FRAMEWORK_SIGNATURES.map(sig => sig.name);
}
